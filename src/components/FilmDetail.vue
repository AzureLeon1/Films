              ...
              <el-aside width="300px">
                ...
                <div class="stars">
                  <el-row>
                    ...
                    <el-col :span="6">
                      <div style="color: #ff9900; font-size: 22px">{{currentFilm.aveRating + "分"}}</div>
                    </el-col>
                  </el-row>
                  <el-row>
                    <div
                      style="text-align:right; padding-right:50px;"
                    >{{"by " + currentFilm.rating.rating_people + " 人评价"}}</div>
                  </el-row>
                  ...
                  <div>
                    <el-row>
                      ...
                      <el-col :span="1">
                        <div style="color: #ff9900; font-size: 16px">{{this.stars5 + "%"}}</div>
                      </el-col>
                    </el-row>
                    ...
                    <el-row>
                      ...
                      <el-col :span="1">
                        <div style="color: #ff9900; font-size: 16px">{{this.stars4 + "%"}}</div>
                      </el-col>
                    </el-row>
                    ...
                    <el-row>
                      ...
                      <el-col :span="1">
                        <div style="color: #ff9900; font-size: 16px">{{this.stars3 + "%"}}</div>
                      </el-col>
                    </el-row>
                    ...
                    <el-row>
                      ...
                      <el-col :span="1">
                        <div style="color: #ff9900; font-size: 16px">{{this.stars2 + "%"}}</div>
                      </el-col>
                    </el-row>
                    ...
                    <el-row>
                      ...
                      <el-col :span="1">
                        <div style="color: #ff9900; font-size: 16px">{{this.stars1 + "%"}}</div>
                      </el-col>
                    </el-row>
                  </div>
                </div>
